...
namespace GSAR_Paperwork_Helper.Models
{
    ...
    public static class OrganizationTools
    {
        ...
        public static List<Organization> GetParentOrganizations()
        {
            ...
            organizations.Add(new Organization(ABSAR, Guid.Empty, "AB Search and Rescue"));
            organizations.Add(new Organization(BCSARA, Guid.Empty, "BC Search and Rescue"));
            organizations.Add(new Organization(SARVAC, Guid.Empty, "SAR Volunteer Assoc. of Canada"));
            organizations.Add(new Organization(Euro, Guid.Empty, "European Association Civil Protection Volunteer Teams"));
            organizations.Add(new Organization(Portugal, Guid.Empty, "Portuguese Teams"));
            organizations.Add(new Organization(NCSAR, Guid.Empty, "North Carolina Search and Rescue"));
            organizations.Add(new Organization(NBSAR, Guid.Empty, "New Brunswick Search and Rescue"));
            organizations.Add(new Organization(LE, Guid.Empty, "Law Enforcement"));

            organizations = organizations.OrderBy(o => o.OrganizationName).ToList();


            organizations.Add(new Organization(OtherOrgs, Guid.Empty, "Other Organizations"));
